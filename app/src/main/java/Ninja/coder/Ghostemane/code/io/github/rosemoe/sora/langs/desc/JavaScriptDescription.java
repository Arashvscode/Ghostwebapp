...
public class JavaScriptDescription implements LanguageDescription {
	...
	public String[] getKeywords() {
		return new String[]{
			"abstract", "else", "instanceof", "prompt","alert", "super", "boolean", "enum", "int", "switch",
			...
			"arguments","parseInt","await","undefined","parseFloat","get","storage.type","infinity","escape","__count__","__parent__","__proto__","window","eval","getElementById","getElementByClass"
		};
	}
