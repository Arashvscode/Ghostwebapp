...
public class GoDescription implements LanguageDescription {
	...
	public String[] getKeywords() {
		...
		return new String[]{"append","bool","break","byte","cap","case","copy",
			"chan","close","complex128","default","defer",
			"defer","delete","else","error","fallthrough",
			"false","float32","float64","for","go","goto",
			"if","imag","import","int","int8","int16",
			"int32","len","make","map","new","nil"
			,"package","panic","print","println","panicln",
			"real","range","recover","return","uint","uint8",
			"uint16","uint32",
			"uint64","uintptr","var"
		};
	}
