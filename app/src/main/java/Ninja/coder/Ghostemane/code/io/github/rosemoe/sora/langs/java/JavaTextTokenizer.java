...
public class JavaTextTokenizer {
	...
	protected static void doStaticInit() {
		sKeywords = new String[]{
			...
			"this", "throw", "throws", "true", "false", "null" , "var" , "system","out","println","format"
		};
		Tokens[] sTokens = new Tokens[]{
			...
			Tokens.THIS, Tokens.THROW, Tokens.THROWS, Tokens.TRUE, Tokens.FALSE, Tokens.NULL, Tokens.VAR , Tokens.SYSTEM,Tokens.OUT,Tokens.FORMAT,Tokens.PRINTLN
		};
