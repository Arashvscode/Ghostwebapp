...
public class GhostWebCustomWebView extends WebView {
	...
	public void Andoidvspc(boolean fff) {
		...
		if (fff) {
			...
			String newUserAgent;
			newUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36";
			webSettings.setUserAgentString(newUserAgent);
			
		} else {
			WebSettings webSettings2 = getSettings();
			String newUserAgent2;
			newUserAgent2 = "Mozilla/5.0 (Linux; Android 7.0; SM-G570M Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/192.0.0.34.85;]";
