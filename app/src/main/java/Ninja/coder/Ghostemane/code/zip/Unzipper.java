...
public class Unzipper {
    ...
    //private static com.balatong.logger.Logger logger = com.balatong.logger.Logger.getLogger(UnzipperService.class.getName());
    ...
    private FileReader.UnzipListener unzipListener = new FileReader.UnzipListener() {
        @Override
        public void onStart() {
            if (listener != null){
                listener.onStart();
