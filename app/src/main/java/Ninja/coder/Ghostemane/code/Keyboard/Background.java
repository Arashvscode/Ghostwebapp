...
public class Background extends AppCompatActivity  { 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		card.setElevation((float)5);
		rang3.getButtonDrawable().setColorFilter(Color.parseColor("#FFFFB49D"), PorterDuff.Mode.SRC_IN);
		rang4.getButtonDrawable().setColorFilter(Color.parseColor("#FFFFB49D"), PorterDuff.Mode.SRC_IN);
		rang5.getButtonDrawable().setColorFilter(Color.parseColor("#FFFFB49D"), PorterDuff.Mode.SRC_IN);
		rang6.getButtonDrawable().setColorFilter(Color.parseColor("#FFFFB49D"), PorterDuff.Mode.SRC_IN);
		rang7.getButtonDrawable().setColorFilter(Color.parseColor("#FFFFB49D"), PorterDuff.Mode.SRC_IN);
	...
	public void Back_Tedad(){
		...
		Value4 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor4", "0")).intValue();
		Value5 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor5", "0")).intValue();
		Value6 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor6", "0")).intValue();
		Value7 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor7", "0")).intValue();
			...
			if (movazirang.isChecked()){
				...
				if (amod.isChecked()){
					...
					if(rang3.isChecked()){
						...
						GradientDrawable drawablecolor = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2});
						view.setBackgroundDrawable(drawablecolor);
					} if(rang4.isChecked()){
					...
					if(rang3.isChecked()){
						...
						GradientDrawable drawablecolor = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2});
						view.setBackgroundDrawable(drawablecolor);
					} if(rang4.isChecked()){
					...
					if(rang3.isChecked()){
						...
						GradientDrawable drawablecolor = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2});
						view.setBackgroundDrawable(drawablecolor);
					} if(rang4.isChecked()){
