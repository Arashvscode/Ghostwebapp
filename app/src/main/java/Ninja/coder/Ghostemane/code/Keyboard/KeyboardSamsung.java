...
public class KeyboardSamsung extends InputMethodService implements KeyboardView.OnKeyboardActionListener { 
	
	Keyboard_View KV;
	LinearLayout LL;
	MyKeyboard english,persian,persian_shift,number,sim_en_1,sim_en_2,sim_fa_1,sim_fa_2;
	...
	public void safahat_dark(){
		if (PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getBoolean("Number", true)) {
	...
	public View onCreateInputView() {
		...
		if (PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getBoolean("Preview", true)) {
			KV.setPreviewEnabled(true);
		} else {
			KV.setPreviewEnabled(false);
		}
		
		if (PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getBoolean("Toolbar", true)) {
			return LL;
		}
		return KV;
	}
	...
	public void onKey(int primaryCode, int[] keyCodes) {
		...
		if (PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getBoolean("Vibrator", true)) {
		...
		switch (primaryCode) {
			...
			if (mCapsR) {
				Toast.makeText(this, "هنگامی که تایپ مختلط فعال است,کلید شیفت بی اثر است.\nبرای غیر فعال کردن این حال کلید شیفت را فشار دهید و نگه دارید.", 1).show();
			} else {
	...
	private void safhe() {
		String SetKeyboard = PreferenceManager.getDefaultSharedPreferences(this).getString("SetKeyboard", "2");
	...
	public void onPress(int primaryCode) {
		if (mCapsR && primaryCode != 0 && primaryCode != -1 && primaryCode != -5 && primaryCode != -6363 && primaryCode != -2) {
			mCapser();
		}
		if (PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getBoolean("Vibrator", true)) {
	...
	public void Vibrator_a(int primaryCode) {
		((Vibrator) getBaseContext().getSystemService("vibrator")).vibrate(getPrefInt(sharedPref,"Vibrator_1", 10));
	}
	public void Vibrator_b(int primaryCode) {
		((Vibrator) getBaseContext().getSystemService("vibrator")).vibrate(getPrefInt(sharedPref,"Vibrator_2", 10));
	}
	...
	public void Background(){
		...
		int Value1 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor1", "0")).intValue();
		int Value2 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor2", "0")).intValue();
		int Value3 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor3", "0")).intValue();
		int Value4 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor4", "0")).intValue();
		int Value5 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor5", "0")).intValue();
		int Value6 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor6", "0")).intValue();
		int Value7 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor7", "0")).intValue();
		int Value8 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor8", "0")).intValue();
		int Value9 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor9", "0")).intValue();
		int Value10 = Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(this).getString("gradientColor10", "0")).intValue();
		
		String Background = PreferenceManager.getDefaultSharedPreferences(this).getString("Background", "asli");
		String Model = PreferenceManager.getDefaultSharedPreferences(this).getString("Model", "takrang");
		String HalatMovazi = PreferenceManager.getDefaultSharedPreferences(this).getString("HalatMovazi", "amod");
		String HalatDavaran = PreferenceManager.getDefaultSharedPreferences(this).getString("HalatDavaran", "pain");
		...
		if (Background.equals("asli")){
			...
			Drawable bitmapDrawable = new BitmapDrawable(PreferenceManager.getDefaultSharedPreferences(this).getString("background", "0"));
			...
			if (Model.equals("takrang")){
				...
				if (HalatMovazi.equals("amod")){
					if (Tedad.equals("rang2")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang3")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang4")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang5")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang6")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5, Value6});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang7")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang8")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang9")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang10")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9, Value10});
						KV.setBackgroundDrawable(drawable);
					}
				} else if (HalatMovazi.equals("dar45")){
					if (Tedad.equals("rang2")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang3")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang4")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang5")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang6")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5, Value6});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang7")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang8")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang9")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang10")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9, Value10});
						KV.setBackgroundDrawable(drawable);
					}
				} else if (HalatMovazi.equals("ofogh")){
					if (Tedad.equals("rang2")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang3")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang4")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang5")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang6")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5, Value6});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang7")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang8")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang9")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9});
						KV.setBackgroundDrawable(drawable);
					} else if (Tedad.equals("rang10")){
						GradientDrawable drawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Value1, Value2, Value3, Value4, Value5, Value6, Value7, Value8, Value9, Value10});
						KV.setBackgroundDrawable(drawable);
					}
				}
