...
public class EditorAutoCompleteWindow extends EditorBasePopupWindow {
	...
	private final ProgressBar mTip;
	...
	*/
	public EditorAutoCompleteWindow(CodeEditor editor) {
		...
		layout.addView(mListView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));
		mTip = new ProgressBar(mEditor.getContext());
		layout.addView(mTip);
